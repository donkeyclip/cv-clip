...
export default () => {
  ...
  clip.addIncident(
    moveRight("0%", ".skills-container", 500, 0, "easeInOutQuint"),
    0
  );
  clip.addIncident(scale(1, ".skills-container", 200, 0, "easeOutSine"), 1000);

  clip.addIncident(
    moveLeft("10%", ".software-skills .title", 500, 0, "easeInOutCubic"),
    1200
  );
  clip.addIncident(
    moveLeft(
  ...
  clip.addIncident(
    moveLeft("10%", ".personal-skills .title", 500, 0, "easeInOutCubic"),
    3200
  );
  clip.addIncident(
    moveLeft(
  ...
  clip.addIncident(
    scale(0.9, ".skills-container", 200, 0, "easeOutSine"),
    6500
  );
  clip.addIncident(
    moveRight("100%", ".skills-container", 500, 0, "easeInOutQuint"),
    7000
  );
  clip.addIncident(
    width(
      "100%",
      ".software-skills .progress-bar",
      1500,
      "@stagger(0,400)",
      "easeOutSine"
    ),
