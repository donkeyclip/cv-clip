...
clip.addIncident(scale(0.8,".project",1000,"@expression(index *5000)","easeOutBounce"),1900)
clip.addIncident(opacity(0,".project",500,"@expression(index*5000)"),6300)
clip.addIncident(opacity(1,".thanks",200,"@expression(index *5000)"),7200)
